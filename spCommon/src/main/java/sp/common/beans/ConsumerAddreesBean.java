 ...
 * @author ADMIN
 */
public class ConsumerAddreesBean {
    	private Integer id;
    ...
    public ConsumerAddreesBean(Integer id, AreaBean area, ConsumerBean consumer, String street, String building, String floor, String flat, String landmark, BigDecimal lat, BigDecimal lng, String label, byte active) {
        this.id = id;
        this.area = area;
